...
class Salad extends Fragment implements RecyclerViewAdapter.ClickAdapterListener{
    View view;
    ...
    private void populateDataAndSetAdapter() {
        ...
        Model model = new Model("Apple Bowl","65","4", "2","Available", R.drawable.foodvillalogo);
        dataModel.add(model);
